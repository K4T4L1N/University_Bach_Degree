    ...
    <div class="card1">
        ...
        <div>
            <form action="function_exportcsv.php" method="post" name="upload_excel"  enctype="multipart/form-data">
                <div class="form-group">
                    <div >
                            <input type="submit" name="Export_prdcts" class="button" value="export products CSV"/>
                    </div>
                </div>                    
            </form>           
        </div>
        ...
        <div>
            <form action="function_exportcsv.php" method="post" name="upload_excel"  enctype="multipart/form-data">
                <div class="form-group">
                    <div >
                            <input type="submit" name="Export_fdbck" class="button" value="export products's feedback CSV"/>
                    </div>
                </div>                    
            </form>           
         </div>
